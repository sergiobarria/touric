...
export const difficultyEnumValues = ['easy', 'moderate', 'difficult'] as const;
export type DifficultyEnum = (typeof difficultyEnumValues)[number];

export const difficultyEnum = pgEnum('difficulty', difficultyEnumValues);
